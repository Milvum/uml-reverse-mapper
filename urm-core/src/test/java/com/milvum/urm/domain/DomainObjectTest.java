...
import com.milvum.urm.domain.DomainField;
import com.milvum.urm.testdomain.weirdos.Colors;
...
public class DomainObjectTest {
    ...
    public void domainObjectConstructedProperlyFromClass() {
        ...
        assertThat(viaClassConstructor,
                new DomainObjectAssertion("com.milvum.urm.domain", "DomainObjectTest"));
    }
    ...
    public void domainConstructedProperlyFromInnerClass() {
        ...
        assertThat(viaClassConstructor,
                new DomainObjectAssertion("com.milvum.urm.domain", "DomainObjectAssertion"));
    }
