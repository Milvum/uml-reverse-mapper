...
import com.milvum.urm.DomainMapper;
import com.milvum.urm.DomainClassFinder;
import com.milvum.urm.presenters.GraphvizPresenter;
import com.milvum.urm.presenters.Presenter;
import com.milvum.urm.testdomain.Selfie;
import com.milvum.urm.testdomain.Task;
import com.milvum.urm.testdomain.Timesheet;
import com.milvum.urm.testdomain.person.DoubleReferer;
import com.milvum.urm.testdomain.person.Employee;
...
public class DomainMapperGraphvizTest {
    ...
    public void testDescribeDomain_singleClass() throws ClassNotFoundException {
        ...
        String pkg = "label = \"com.milvum.urm.testdomain.person\";";
    ...
    public void testDescribeDomain_selfie() throws ClassNotFoundException {
        ...
        String description = GRAPHVIZ_START;
        assertThat(getRepresentationContent(), containsString(description));
        String pkg = "label = \"com.milvum.urm.testdomain\";";
        assertThat(getRepresentationContent(), containsString(pkg));
    ...
    public void testDescribeDomain() throws ClassNotFoundException {
        ...
        String pkg1 = "label = \"com.milvum.urm.testdomain\";";
        ...
        String pkg2 = "label = \"com.milvum.urm.testdomain.person\";";
    ...
    public void testCreate() throws Exception {
        DomainMapper mapper = DomainMapper.create(presenter, Arrays.asList("com.milvum.urm.testdomain"));
